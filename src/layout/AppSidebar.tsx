          ...
          {isExpanded || isHovered ? (
            <>
              ...
              <div className="leading-none">
                <h1
                  className="text-[42px] font-bold text-[#1E5B34]"
                  style={{ fontFamily: "Playfair Display, serif" }}
                >
                  {AppConfig.secondaryCompanyName}
                </h1>

                <p className="text-xs uppercase tracking-[0.28em] text-gray-600 mt-1">
                  {AppConfig.secondayCompanySubName}
                </p>
              </div>
            </>
          ) : (
